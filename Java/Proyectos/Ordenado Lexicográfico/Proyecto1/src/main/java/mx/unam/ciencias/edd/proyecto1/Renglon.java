...
/**
 * Clase encargada de simular el compartamiento de cada renglon recibido en la clase proyecto.
 * La clase tiene un atributo String cadena que es el valor en cadena de dicho renglon.
 * Sobreescribimos el método compareTo para poder comparar ocn los parámetros que queremos
 *
